...
insert into tb_producto (descripcion, marca, precio, stock, medida, id_categoria) values ('Pisco Embajador Quebranta', 'Embajador', 25.90, 50, '700ml', 1)
insert into tb_producto (descripcion, marca, precio, stock, medida, id_categoria) values ('Cerveza Revolucion Craft', 'Revolucion', 10.90, 20, '330ml', 1)
insert into tb_producto (descripcion, marca, precio, stock, medida, id_categoria) values ('Papas Lays Clasicas', 'Frito Lay', 16.50, 30, '160gr', 2)
insert into tb_producto (descripcion, marca, precio, stock, medida, id_categoria) values ('Maní Crocante Karinto', 'Karinto', 3.40, 25, '100gr', 2)
insert into tb_producto (descripcion, marca, precio, stock, medida, id_categoria) values ('Chicle Trident Fresa', 'Trident', 2.90, 35, '30gr', 3)
insert into tb_producto (descripcion, marca, precio, stock, medida, id_categoria) values ('Bizcocho Chocman', 'Costa', 2.90, 30, '30gr', 3)
insert into tb_producto (descripcion, marca, precio, stock, medida, id_categoria) values ('Tres Leches Tambo', 'Tambo', 3.90, 10, '1und', 4)
insert into tb_producto (descripcion, marca, precio, stock, medida, id_categoria) values ('Pan Bimbo Integral', 'Bimbo', 6.90, 15, '480gr', 4)
insert into tb_producto (descripcion, marca, precio, stock, medida, id_categoria) values ('Leche Gloria UHT', 'Gloria', 3.90, 35, '900ml', 5)
insert into tb_producto (descripcion, marca, precio, stock, medida, id_categoria) values ('Helado Donofrio Sublime', 'Donofrio', 2.80, 20, '75ml', 5)
insert into tb_producto (descripcion, marca, precio, stock, medida, id_categoria) values ('Detergente Ariel Revitacolor', 'Ariel', 5.80, 25, '500gr', 6)
insert into tb_producto (descripcion, marca, precio, stock, medida, id_categoria) values ('Lavavajilla Ayudin Limon', 'Ayudin', 2.90, 10, '300gr', 6)
insert into tb_producto (descripcion, marca, precio, stock, medida, id_categoria) values ('Aceite Primor clasico', 'Primor', 8.00, 30, '1lt', 7)
insert into tb_producto (descripcion, marca, precio, stock, medida, id_categoria) values ('Conserva Trozos de Atun Campomar', 'Campomar', 5.20, 30, '170gr', 7)
